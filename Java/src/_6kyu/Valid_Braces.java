...
public class Valid_Braces {
    public static void main(String[] args) {
        ...
        Valid_Braces vb = new Valid_Braces();
        System.out.println(true + ", " + vb.isValid("()"));
        System.out.println(false + ", " + vb.isValid("\"[(])\""));


    }

    public boolean isValid(String braces) {
        if (braces.chars().filter(ch -> ch == '(').count() == braces.chars().filter(ch -> ch == ')').count() &&
